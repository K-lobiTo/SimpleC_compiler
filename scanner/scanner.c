...
const char* tTypeToStr(TokenType t) {
    switch (t) {
        ...
        // Additional keywords
        case TOK_LONG_LONG:     return "TOK_LONG_LONG";
        case TOK_LONG_DOUBLE:   return "TOK_LONG_DOUBLE";
        ...
        case TOK_IMAGINARY:     return "TOK_IMAGINARY";
        case TOK_THREAD_LOCAL:  return "TOK_THREAD_LOCAL";
        case TOK_ATOMIC:        return "TOK_ATOMIC";
        ...
        // Special
        case TOK_COUNT:         return "TOK_COUNT";
...
TokenCount getTokenCount(){
    TokenCount theCount;
    memcpy(theCount.token_count, token_counts, sizeof(token_counts));
    return theCount;
}
