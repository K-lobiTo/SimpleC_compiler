...
\newcommand{\keyword}{23}
\newcommand{\operadoresysimbolos}{117}
\newcommand{\literaleseidentificadores}{75}
\newcommand{\erroresyfindearchivo}{2}
...
\newcommand{\tokdot}{1}
\newcommand{\tokarrow}{0}
\newcommand{\toklparen}{19}
\newcommand{\tokrparen}{14}
\newcommand{\toklbrace}{6}
\newcommand{\tokrbrace}{5}
\newcommand{\toklbracket}{9}
\newcommand{\tokrbracket}{9}
\newcommand{\toksemicolon}{24}
\newcommand{\tokcolon}{0}
\newcommand{\tokcomma}{4}
\newcommand{\tokellipsis}{0}

\newcommand{\tokidentifier}{49}
\newcommand{\tokintliteral}{15}
\newcommand{\tokfloatliteral}{1}
\newcommand{\tokstringliteral}{10}
